...
[**Code snapshot**](https://github.com/shubhamx64/residual-thoughts-blog/tree/main/code/live) — the footprint capture, weight-geometry, co-use, sequential-update, census, and quantization pipelines. The research mirror deliberately excludes Paper 2's mechanism work; this post is Paper 1 only.
:::
...
not settle the mechanism. That question belongs to Paper 2, and to a later post.
